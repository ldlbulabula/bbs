...
<%--                    <b></b>--%>
                    <span class="errorMsg">
<%--					请输入用户名和密码--%>
						${empty requestScope.loginMessage?"请输入管理员账户和密码":requestScope.loginMessage}
					</span>
                </div>
                <div class="form">

                    <form action="${requestScope.basePath}adminServlet" method="post">
                        <input type="hidden" name="action" value="AdminLogin">
                        <label for="email">账户：</label>
                        <input class="itxt" type="text" id="email" placeholder="请输入管理员账号(邮箱格式)" autocomplete="off" tabindex="1" name="email"
